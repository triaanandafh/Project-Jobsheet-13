        ...
        for (int i = 0; i < achievementData.length; i++) {
            if(achievementData[i][0] != null && !achievementData[i][0].isEmpty()){
                ...
                for(int j = 0; j < achievementData[i].length; j++){
                    switch (j) {
                        case 0:
                            System.out.print("Name: " + achievementData[i][j]);
                            break;
                        case 1:
                            System.out.print(" | NIM: " + achievementData[i][j]);
                            break;
                        case 2:
                            System.out.print(" | Type: " + achievementData[i][j]);
                            break;
                        case 3:
                            System.out.print(" | Level: " + achievementData[i][j]);
                            break;
                        case 4:
                            System.out.print(" | Year: " + achievementData[i][j]);
                            break;
                    }
                }
                System.out.println();
